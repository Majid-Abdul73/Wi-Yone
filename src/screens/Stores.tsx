        ...
        <div className="relative z-10">
          ...
          <div className="container mx-auto px-4 py-8">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-2 bg-[#FFFEFC] -mt-60 rounded-[20px] p-6">
                {loading && stores.length === 0 ? (
                  <div className="flex justify-center items-center py-12">
                    <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-[#212c2d]"></div>
                  ...
                  <div className="text-center py-12">
                    ...
                    <button 
                      onClick={handleRetry}
                      className="bg-[#212c2d] text-white px-4 py-2 rounded-lg hover:bg-[#2a3738] transition-colors"
                    >
                      Retry
                    </button>
                  </div>
                  ...
                  <>
                    ...
                    {loading && stores.length > 0 && (
                      <div className="fixed bottom-4 right-4 bg-green-500 text-white px-3 py-2 rounded-lg shadow-lg flex items-center">
              ...
              <div className="lg:col-span-1 -mt-60">
                <div className="bg-gradient-to-b from-[#e15822] to-[#d14812] rounded-[20px] shadow-lg p-8 text-white sticky top-8 max-w-xs mx-auto">
                  {/* Tent Display Image */}
                  ...
                  <div className="text-start space-y-6">
                    <div className="border-b">
                      <div className="text-6xl font-bold mb-2" style={{ fontFamily: 'BigNoodleTitling, sans-serif' }}>
                        {loading && stores.length === 0 ? (
                          <div className="animate-pulse bg-white/20 h-16 w-16 rounded"></div>
                        ) : (
                          stores.length
                        )}
                      </div>
                      <div className="text-lg opacity-90" style={{ fontFamily: 'BigNoodleTitling, sans-serif' }}>Locations</div>
                    ...
                    <div>
                      ...
                      <div className="text-lg opacity-90" style={{ fontFamily: 'BigNoodleTitling, sans-serif' }}>Countries</div>
                    </div>
                  </div>
                </div>
              </div>
